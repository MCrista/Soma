<form id="frmCrearImpedimento" method="POST" onsubmit="return CrearImpedimento()">
    <div class="modal fade" id="modalCrearImpedimento" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Crear Impedimento</h5>
